...
import { Plus, Search, Users, Truck, UserCheck, Star } from 'lucide-react'
...
const KPI_STRIP = [
  { label: 'Total Drivers', value: String(MOCK_DRIVERS.length), icon: Users },
  { label: 'On Load',       value: String(onLoad),              icon: Truck },
  { label: 'Available',     value: String(available),           icon: UserCheck },
  { label: 'Avg Safety',    value: `${avgSafety}/10`,           icon: Star },
]
